...
spins drawn from an isotropic distribution. The evidence ratios of these mixture models to the isotropic distribution with ``low'' spin magnitudes are 0.43, 0.20 and 0.10 for the ``low'', ``flat''
and ``high'' spin magnitude models. Thus we cannot rule out a mixture with
