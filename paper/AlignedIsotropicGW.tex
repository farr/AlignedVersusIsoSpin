...
\begin{abstract}
  ...
  \acp{GW}\cite{2016PhRvL.116f1102A,2016PhRvL.116x1103A,O1-BBH} from
  merging \acp{BBH} open a unique window into the \ac{BBH} formation
  ...
  expected to have isotropic spin
  ...
  a consequence of their joint evolution toward a \ac{BBH}
  ...
  best-measured combination of spin
...
projections of the individual \ac{BH} spins\cite{2016PhRvL.116x1102A}.
...
measurements (see Section \ref{sec:discussion}).  The analysis here is
