...
\begin{abstract}
  ...
  angular momentum as a consequence of their joint evolution toward a
  binary black hole
  ...
  to high values we show that the data already exhibit a
  ...
  of 10 additional detections\cite{2016ApJ...833L...1A} of systems, we
  show that if all observations come from a single population such an
  augmented data set would typically enable at least a
