...
\begin{abstract}
  ...
  over an aligned one.  By considering the effect of 10 additional
  detections\cite{2016ApJ...833L...1A}, we show that such an augmented
  data set would enable in most cases a preference stronger than
...
\ref{fig:O1-posteriors}\footnote{The measurement uncertainty in
  $\chieff$ depends on the other parameters of the merging binary
...
($2.9 \times 10^{-7}$ odds) credibility. In the most pessimistic case
the distinction is typically $\OTwoSigmaIsoAlignedMin\sigma$
...
until we have a larger number of observations.  
